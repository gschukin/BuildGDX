...
public abstract class BuildControls {
    ...
    protected BuildGamepadManager gpmanager;
    protected BuildConfig pCfg;

    public enum JoyStick {Turning, Moving}

    public BuildControls(BuildConfig cfg, BuildGamepadManager gpmanager) {
        this.pCfg = cfg;
    ...
    public BuildGamepadManager getGPManager() {
        return gpmanager;
    }
    ...
    public void ctrlMouseHandler() {
        ...
        if (pCfg.useMouse) {
            ...
            int dx = Gdx.input.getDeltaX(); //BuildGdx.input.getX() - oldPosX;
            int dy = Gdx.input.getDeltaY(); //BuildGdx.input.getY() - oldPosY;
    ...
    public boolean ctrlPadStatusOnce(GameKey buttonCode) {
    ...
    public boolean ctrlPadStatus(GameKey buttonCode) {
        if (buttonCode instanceof MenuKeys) {
    ...
    public boolean ctrlKeyStatusOnce(int keyId) {
        return false; //getInputController().keyStatusOnce(keyId);
    }

    public boolean ctrlKeyStatus(int keyId) {
        return false; //getInputController().keyStatus(keyId);
    }

    public boolean ctrlKeyPressed(int keyId) {
        return false; //getInputController().keyPressed(keyId);
    }

    public boolean ctrlGetInputKey(GameKey keyName, boolean once) {
...
//		Arrays.fill(getInputController().hitkey, false);
    ...
    public BuildGamepadManager ctrlGetGamepadManager() {
        return gpmanager;
    }
