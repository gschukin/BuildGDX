...
public class Sprite {
	...
	public Sprite readObject(InputStream is) throws IOException {
    	...
    	setClipdist(StreamUtils.readSignedByte(is));
    	setDetail(StreamUtils.readSignedByte(is));
    	setXrepeat(StreamUtils.readSignedByte(is));
    	setYrepeat(StreamUtils.readSignedByte(is));
    	setXoffset(StreamUtils.readSignedByte(is));
    	setYoffset(StreamUtils.readSignedByte(is));
