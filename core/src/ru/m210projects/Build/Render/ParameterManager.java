...
public class ParameterManager {
	...
	public void setMultisample(boolean enable) {
		if (enable) {
            Gdx.gl.glEnable(GL10.GL_MULTISAMPLE);
        } else {
            Gdx.gl.glDisable(GL10.GL_MULTISAMPLE);
        }
	}

	public void loadMatrixf(float[][] m) {
		((GL10) Gdx.gl).glLoadMatrixf(m);
	}

	public void ortho(float left, float right, float bottom, float top, float zNear, float zFar) {
		((GL10) Gdx.gl).glOrthof(left, right, bottom, top, zNear, zFar);
	}
	...
	public void alphaFunc(int func, float ref) {
		((GL10) Gdx.gl).glAlphaFunc(func, ref);
	}

	public void matrixMode(int mode) {
		((GL10) Gdx.gl).glMatrixMode(mode);
	}
	...
	public void texEnvf(int target, int pname, float param) { // XXX ?
		((GL10) Gdx.gl).glTexEnvf(target, pname, param);
	}

	public void fogi(int pname, int params) {

		((GL10) Gdx.gl).glFogi(pname, params);
	}
	...
	public void fogf(int pname, float param) {
		...
		((GL10) Gdx.gl).glFogf(pname, param);
	}
	...
	public void fogfv(int pname, float[] params, int offset) {
		...
		((GL10) Gdx.gl).glFogfv(pname, params, offset);
	}
	...
	public void rotate(float angle, float x, float y, float z) {
		((GL10) Gdx.gl).glRotatef(angle, x, y, z);
	}

	public void scale(float x, float y, float z) {
		((GL10) Gdx.gl).glScalef(x, y, z);
	}

	public void translate(float x, float y, float z) {
		((GL10) Gdx.gl).glTranslatef(x, y, z);
	}
